 ...
 */
class KONSOLEPRIVATE_EXPORT TerminalDisplay : public QQuickItem
{
   Q_OBJECT
   ...
   Q_PROPERTY(bool sharedFrameMode      READ sharedFrameMode WRITE setSharedFrameMode)
   Q_PROPERTY(QString sharedFramePath   READ sharedFramePath WRITE setSharedFramePath NOTIFY sharedFramePathChanged)
...
public:
     ...
     */
    void setUseFBORendering(bool) {}

    /**
     * Returns true if using FramebufferObject rendering, false if using Image.
     */
    bool useFBORendering() const { return true; }

    void setSharedFrameMode(bool enabled);
    bool sharedFrameMode() const { return _sharedFrameMode; }
    void setSharedFramePath(const QString &path);
    QString sharedFramePath() const;
...
private:
    ...
    bool _sharedFrameMode;
    QString _sharedFramePath;
    QTimer* _sharedFrameTimer;
    QFile* _sharedFrameFile;
    uchar* _sharedFrameMap;
