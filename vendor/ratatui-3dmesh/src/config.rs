...
pub struct Mesh3dConfig {
    ...
    /// Mirror the projected image horizontally without changing model orientation.
...
impl Mesh3dConfig {
    ...
    #[must_use]
    pub fn flip_horizontal(mut self, enabled: bool) -> Self {
...
mod tests {
    ...
    fn builders_clamp_values() {
        ...
        assert!(!cfg.flip_horizontal);
        assert_eq!(cfg.ambient, 0.0);
        assert_eq!(cfg.diffuse, 1.0);
    }

    #[test]
    fn horizontal_flip_is_opt_in() {
        assert!(
